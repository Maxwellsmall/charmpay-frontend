  ...
  return (
    <View className="flex-1 justify-start items-center bg-white pt-[20px]">
      <View>
        ...
        <View className=" text-center mb-[20px]">
          <Text className="text-[17px] ">
            An OTP has been sent to your Email(maxwell****88gmail.com)
          </Text>
        </View>
      </View>
      {/* Passcode Input */}
      ...
      />
      <TouchableOpacity className="mt-[-5px] rounded-lg flex-row justify-center items-center">
        <Text className="text-black text-right font-semibold">
      ...
      <TouchableOpacity
        ...
        onPress={() => router.navigate("/settings/security/pass/newtrans")}
      >
